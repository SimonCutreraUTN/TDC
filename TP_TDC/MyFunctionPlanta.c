 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Tue Jul 23 19:14:54 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                MyFunctionPlanta
...
extern void MyFunctionPlanta_Outputs_wrapper(const real_T *nodosAProduccion,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port nodosAProduccion of S-Function MyFunctionPlanta");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port trxXSeg of S-Function MyFunctionPlanta");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port usoCPU of S-Function MyFunctionPlanta");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  MyFunctionPlanta_Outputs_wrapper(nodosAProduccion, trxXSeg, usoCPU);
}
