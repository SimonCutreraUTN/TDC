 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sat Jul 20 11:42:17 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                myTestFunction
...
extern void myTestFunction_Outputs_wrapper(const real_T *u0,
  real_T *y0);
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u0 of S-Function myTestFunction");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function myTestFunction");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  myTestFunction_Outputs_wrapper(u0, y0);
}
