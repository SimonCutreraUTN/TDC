/*
 * File: myTestFunctionMultInput.c
 *
 *
 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Sat Jul 20 12:48:30 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                myTestFunctionMultInput
...
/* Input Port  0 */
#define IN_PORT_0_NAME                 currentReplicas
...
/* Input Port  1 */
#define IN_PORT_1_NAME                 desiredMetricValues
...
/* Input Port  2 */
#define IN_PORT_2_NAME                 signalError
...
/* Output Port  0 */
#define OUT_PORT_0_NAME                desiredReplicas
...
extern void myTestFunctionMultInput_Outputs_wrapper(const real_T
  *currentReplicas,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port currentReplicas of S-Function myTestFunctionMultInput");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port desiredMetricValues of S-Function myTestFunctionMultInput");
      return;
    }
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port signalError of S-Function myTestFunctionMultInput");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port desiredReplicas of S-Function myTestFunctionMultInput");
      return;
    }
...
{
  const real_T *currentReplicas = (real_T *) ssGetInputPortRealSignal(S, 0);
  const real_T *desiredMetricValues = (real_T *) ssGetInputPortRealSignal(S, 1);
  const real_T *signalError = (real_T *) ssGetInputPortRealSignal(S, 2);
  real_T *desiredReplicas = (real_T *) ssGetOutputPortRealSignal(S, 0);
  myTestFunctionMultInput_Outputs_wrapper(currentReplicas, desiredMetricValues,
    signalError, desiredReplicas);
}
